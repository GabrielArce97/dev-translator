...
export default function Home() {
  ...
  const languages = [
    { name: 'Python', icon: <SiPython className="text-[#3776AB]" />, color: '#3776AB' },
    ...
    { name: 'Swift', icon: <SiSwift className="text-[#F05138]" />, color: '#F05138' },
    { name: 'Go', icon: <SiGo className="text-[#00ADD8]" />, color: '#00ADD8' },
    { name: 'Rust', icon: <SiRust className="text-[#DEA584]" />, color: '#DEA584' },
  ];
      ...
      <div className="max-w-7xl mx-auto px-6 py-16 relative z-10 w-full flex-1 flex flex-col">
        ...
        <div className="text-center mb-16 space-y-6">
          ...
          <h1 className="text-5xl md:text-7xl font-bold tracking-tighter text-white">
            Dev<span className="text-transparent bg-clip-text bg-gradient-to-r from-blue-400 to-indigo-500">Translator</span>
            <span className="text-blue-500">.</span>
          </h1>
          
          <p className="text-neutral-400 text-lg md:text-xl max-w-xl mx-auto leading-relaxed">
            Seamlessly convert code between languages with <span className="text-neutral-200 font-medium">intelligent context preservation</span>.
          </p>
        </div>
          ...
          <div className="flex flex-col space-y-3 h-full">
            ...
            >
              {isLoading ? (
                ...
                <>
                  <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={2} stroke="currentColor" className="h-5 w-5 text-neutral-400 group-hover:text-blue-500 transition-colors">
            ...
            <div className="flex-1 w-full bg-[#1e1e1e] rounded-2xl border border-neutral-800 overflow-hidden relative shadow-2xl group ring-1 ring-white/5 min-h-[500px]">
              ...
              {latestResponse ? (
                ...
                <div className="h-full flex flex-col items-center justify-center text-neutral-600 gap-6">
                  ...
                  <p className="text-sm font-medium opacity-50">Select a language & paste code</p>
                </div>
              )}
            </div>
          </div>
